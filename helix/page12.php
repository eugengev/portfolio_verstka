...
<main class="main">
	...
	<div class="content">
		<div class="certificate-page">
			<h1 class="certificate-page__h1">Аттестаты и сертификаты</h1>
			<h2 class="certificate-page__h2">название группы</h2>
			<ul class="certificate-page__list">
				<li><a href="#popup-pic" data-picotziv="./images/_attestat_1.jpg" rel="modal">
					<div class="certificate-page__list-img"><img src="./images/_attestat_1.jpg" height="256" width="196" alt="" /></div>
					Аттестация на монтажные работы
				</a></li>
				<li><a href="#popup-pic" data-picotziv="./images/_sert_01.jpg" rel="modal">
					<div class="certificate-page__list-img"><img src="./images/_sert_01.jpg" height="256" width="196" alt="" /></div>
					Аттестация на монтажные работы
				</a></li>
				<li><a href="#popup-pic" data-picotziv="./images/_stk_1.jpg" rel="modal">
					<div class="certificate-page__list-img"><img src="./images/_stk_1.jpg" height="256" width="196" alt="" /></div>
					Аттестация на монтажные
				</a></li>
				<li><a href="#popup-pic" data-picotziv="./images/pic-otziv.jpg" rel="modal">
					<div class="certificate-page__list-img"><img src="./images/certifik-1.jpg" height="256" width="196" alt="" /></div>
					Аттестация на монтажные работы
				</a></li>
			</ul>
			<h2 class="certificate-page__h2">название группы</h2>
...
<div id="popup-pic" class="modal modal-pic">
