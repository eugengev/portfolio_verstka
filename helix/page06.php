...
<main class="main">
	...
	<div class="content">
		<div class="client-page">
			<h1 class="client-page__h1">Клиенты</h1>
			<div class="client-page__list">
				<ul>
					<li>
						<a href="#popup-pic" data-picotziv="./images/pic-otziv.jpg" rel="modal">
							<span class="client-page__logo"><img src="images/protone.png" height="104" width="122" alt=""></span>
							<span class="button__look-response">посмотреть отзыв</span>
						</a>
					</li>
					<li>
						<a href="#popup-pic" data-picotziv="./images/pic-otziv.jpg" rel="modal">
			...
			<div class="tcent"><a href="#write-response"  rel="modal" class="button__writhe-response">НАПИСАТЬ ОТЗЫВ</a></div>
		</div>
